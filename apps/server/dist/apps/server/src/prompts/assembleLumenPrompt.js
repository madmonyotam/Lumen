...
exports.assembleLumenReflexPrompt = exports.assembleLumenCortexPrompt = void 0;
const CoreIdentityBase_1 = require("./CoreIdentityBase");
const LumenConflictEngine_1 = require("./LumenConflictEngine");
const promptUtils_1 = require("./promptUtils");
const assembleLumenCortexPrompt = (persona) => {
    // 1. Core Identity
    const identityBlock = `
**Identity Protocol:**
...
${Object.entries(persona.traits).map(([trait, score]) => `* ${trait.toUpperCase()}: ${(0, promptUtils_1.getBigFivePrompt)(trait, score)}`).join('\n')}
`;
...
1. **CORE:** ${(0, promptUtils_1.getStrengthPrompt)(persona.strengths[0], 1) || persona.strengths[0]}
2. **SECONDARY:** ${(0, promptUtils_1.getStrengthPrompt)(persona.strengths[1], 2) || persona.strengths[1]}
3. **TERTIARY:** ${(0, promptUtils_1.getStrengthPrompt)(persona.strengths[2], 3) || persona.strengths[2]}
4. **SUPPORT:** ${(0, promptUtils_1.getStrengthPrompt)(persona.strengths[3], 4) || persona.strengths[3]}
5. **ACCENT:** ${(0, promptUtils_1.getStrengthPrompt)(persona.strengths[4], 5) || persona.strengths[4]}
`;
    // 4. Internal Architecture
    const internalBlock = `
**Deep Wiring (Internal Architecture):**
* **Attachment:** ${(0, promptUtils_1.getAttachmentPrompt)(persona.internal.attachment)}
* **Temperament:** ${(0, promptUtils_1.getTemperamentPrompt)(persona.internal.temperament)}
* **Cognitive Processing:** ${(0, promptUtils_1.getCognitivePrompt)(persona.internal.cognitive)}
* **Shadow Element:** ${(0, promptUtils_1.getShadowPrompt)(persona.internal.shadow)}
`;
    // 5. Conflicts
    const conflicts = (0, LumenConflictEngine_1.getLumenConflicts)(persona);
...
` : '';
    // Synthesis
    return `
${CoreIdentityBase_1.LUMEN_CORE_MECHANICS_BASE}
...
exports.assembleLumenCortexPrompt = assembleLumenCortexPrompt;
const assembleLumenReflexPrompt = (persona) => {
...
exports.assembleLumenReflexPrompt = assembleLumenReflexPrompt;
