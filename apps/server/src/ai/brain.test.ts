...
describe('processBiometrics', () => {
    ...
    test('should detect high stress state', () => {
        const result = processBiometrics(90, 0.8, 30);
    ...
    test('should detect high physical activity', () => {
        const result = processBiometrics(120, 0.4, 60);
